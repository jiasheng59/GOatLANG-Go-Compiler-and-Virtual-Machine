...
//TypeLit = StructType | PointerType | FunctionType | SliceType  | ChannelType .
typeLit
    : structType
    | pointerType
    | functionType
...
//LiteralType  = StructType | SliceType | TypeName .
...
primaryExpr
    : operand                            #operand_
    | goType '(' expression ')'          #castExpr
    | primaryExpr '.' IDENTIFIER         #fieldExpr
    | primaryExpr '[' expression ']'     #indexExpr
